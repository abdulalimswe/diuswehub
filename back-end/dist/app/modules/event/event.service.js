...
const createEventIntoDB = (eventData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield event_model_1.Event.create(eventData);
        return result;
    }
    catch (error) {
...
const getAllEventFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const eventQuery = new QueryBuilder_1.default(event_model_1.Event.find(), query)
        .search(event_constant_1.eventSearchableFields)
        .filter()
        .sort()
        .paginate()
        .fields();
...
const getASpecificEventFromDB = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield event_model_1.Event.findOne({ _id });
    return result;
});
const updateEventIntoDB = (_id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield event_model_1.Event.findByIdAndUpdate(_id, payload, {
        new: true,
        runValidators: true,
    });
    console.log(result);
...
const deleteEventFromDB = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield event_model_1.Event.findByIdAndDelete(_id);
    return result;
});
